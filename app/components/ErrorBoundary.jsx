...
export class ErrorBoundary extends Component {
    ...
    render() {
        if (this.state.hasError) {
            return (this.props.fallback || (<div className="min-h-screen bg-background flex items-center justify-center p-4">
            <div className="max-w-lg w-full space-y-6">
              ...
              <div className="text-center space-y-4">
                ...
                {/* Stack Trace */}
                {this.state.error?.stack && (<ScrollArea className="mt-3 h-32 p-4 rounded-lg border border-border/50 bg-muted/50">
